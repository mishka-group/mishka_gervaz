defmodule MishkaGervaz.Table.Behaviours.UIAdapter do
  @moduledoc """
  ...
  Use `use MishkaGervaz.Table.Behaviours.UIAdapter` to get default implementations
  ...
  ## Options
    ...
    * `:fallback` - Fallback module for defaults. Defaults to `MishkaGervaz.Table.UIAdapters.Tailwind`
