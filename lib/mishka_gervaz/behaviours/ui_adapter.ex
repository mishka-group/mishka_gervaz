defmodule MishkaGervaz.Behaviours.UIAdapter do
  ...
  @components [
    ...
    {:copy_button, "Render a copy-to-clipboard button for a value"},
    ...
    {:cell_avatars, "Render an overlapping avatar stack with a +N inline expand/collapse toggle"},
    {:cell_stacked, "Render a two-line cell: a primary line over a quieter secondary one"},
    {:cell_stats, "Render a wrapping row of icon+count markers and chips"},
    {:cell_bars, "Render a bar-gauge cell (a numeric value as filled bars + the number)"},
